...
local function GetAssault()
    ...
    if textures and textures[1].fileDataIDs[1] == 3165083 then
        if BattleForAzeroth:GetOpt('show_debug_map') then BattleForAzeroth.Debug('Uldum assault: AQR') end
        return AQR -- left
    elseif textures and textures[1].fileDataIDs[1] == 3165092 then
        if BattleForAzeroth:GetOpt('show_debug_map') then BattleForAzeroth.Debug('Uldum assault: EMP') end
        return EMP -- middle
    elseif textures and textures[1].fileDataIDs[1] == 3165098 then
        if BattleForAzeroth:GetOpt('show_debug_map') then BattleForAzeroth.Debug('Uldum assault: AMA') end
        return AMA -- right
    end
end
