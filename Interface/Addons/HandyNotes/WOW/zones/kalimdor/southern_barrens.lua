...
local map = WorldOfWarcraft.Map({id = 199, settings = true})
...
map.nodes[41431300] = WorldOfWarcraft.node.Dragonrace({
    label = '{quest:75412}',
    normal = {2321, 53, 48},
    advanced = {2351, 48, 43},
    reverse = {2381, 49, 44},
...
map.nodes[42809308] = WorldOfWarcraft.node.Dragonrace({
    label = '{quest:75437}',
    normal = {2322, 58, 53},
    advanced = {2352, 52, 47},
    reverse = {2382, 52, 47},
