...
---------------------------------- NAMESPACE ----------------------------------
-------------------------------------------------------------------------------
local ADDON_NAME, WorldOfWarcraft = ...
...
local map = WorldOfWarcraft.Map({id = 64, settings = true})
...
map.nodes[09731735] = WorldOfWarcraft.node.Dragonrace({
    label = '{quest:75463}',
    normal = {2323, 88, 83},
...
map.nodes[76807530] = WorldOfWarcraft.node.ScavengerPool(3876)
map.nodes[79207040] = WorldOfWarcraft.node.ScavengerPool(3876)
map.nodes[80407330] = WorldOfWarcraft.node.ScavengerPool(3876)
map.nodes[89607720] = WorldOfWarcraft.node.ScavengerPool(3876)
map.nodes[90007350] = WorldOfWarcraft.node.ScavengerPool(3876)
map.nodes[92707120] = WorldOfWarcraft.node.ScavengerPool(3876)
