...
map.nodes[51601080] = WorldOfWarcraft.node.AnniversaryRare({
    id = 121912,
    quest = 47463,
    rewards = {
...
map.nodes[64125436] = WorldOfWarcraft.node.Dragonrace({
    label = '{quest:75470}',
    normal = {2323, 94, 89},
    advanced = {2353, 88, 83},
    reverse = {2383, 88, 83},
...
map.nodes[24304670] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[29105570] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[29404110] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[33104540] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[33805200] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[36303570] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[40403740] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[44104520] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[44304030] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[44405260] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[46505760] = WorldOfWarcraft.node.ScavengerPool(3875)
map.nodes[47005260] = WorldOfWarcraft.node.ScavengerPool(3875)
