...
local map = WorldOfWarcraft.Map({id = 37, settings = true})
-- local northshire = WorldOfWarcraft.Map({id = 425, settings = true})
local stormwind = WorldOfWarcraft.Map({id = 84, settings = true})
...
map.nodes[44215344] = WorldOfWarcraft.node.CrazyForCats({
    faction = 'Alliance',
    id = 6367,
    rewards = {
        WorldOfWarcraft.reward.Achievement({
            id = 8397,
            criteria = {23587, 23578, 23582, 23592},
            oneline = true
        }), WorldOfWarcraft.reward.Pet({item = 8485, id = 40}),
        WorldOfWarcraft.reward.Pet({item = 8486, id = 41}),
        WorldOfWarcraft.reward.Pet({item = 8487, id = 43}),
        WorldOfWarcraft.reward.Pet({item = 8488, id = 45})
    }
}) -- Donni Anthania - Cat Carrier (Bombay), Cat Carrier (Cornish Rex), Cat Carrier (Orange Tabby), Cat Carrier (Silver Tabby)

stormwind.nodes[44215344] = WorldOfWarcraft.node.CrazyForCats({
    parent = map.id,
    faction = 'Alliance',
