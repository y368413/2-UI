...
local Vendor = TheWarWithin.node.Vendor
...
map.nodes[49053163] = Treasure({ -- Inside the Inn
    quest = 82464,
    requires = {
        TheWarWithin.requirement.Item(223878), TheWarWithin.requirement.Item(223879),
        TheWarWithin.requirement.Item(223880), TheWarWithin.requirement.Item(223881),
        TheWarWithin.requirement.Item(223882)
    },
    rewards = {
...
map.nodes[50485349] = Treasure({ -- lvl 71
    quest = 80485,
    requires = {
        TheWarWithin.requirement.Item(217960) -- Forgotten Key
    },
...
map.nodes[61583760] = TheWarWithin.node.PetBattle({
    id = 223444,
    rewards = {
...
map.nodes[66855808] = TheWarWithin.node.PetBattle({
    id = 222535,
    rewards = {
...
map.nodes[61516421] = Collectible({
    ...
    group = TheWarWithin.groups.I_ONLY_NEED_ONE_TRIP,
...
local BustedConsole = Class('BustedConsole', Collectible, {
    icon = 134067,
    group = TheWarWithin.groups.NOT_SO_QUICK_FIX,
...
local MachineSpeakerNote = Class('MachineSpeakerNote', Collectible, {
    icon = 1506451,
    group = TheWarWithin.groups.NOTABLE_MACHINES,
...
local InertEarthen = Class('InertEarthen', Collectible, {
    icon = 5788303,
    group = TheWarWithin.groups.ROCKED_TO_SLEEP,
...
local GobblinWithGlublurp = Class('gobblin_with_glublurp', Collectible, {
    icon = 5763494,
    group = TheWarWithin.groups.GOBBLIN_WITH_GLUBLURP
...
local CritterLove = Class('CritterLove', Collectible, {
    group = TheWarWithin.groups.CRITTER_LOVE,
    icon = 3459801,
...
local ReclamationMachinist = Class('ReclamationMachinist', Collectible, {
    ...
    icon = 'peg_yw',
    scale = 1.5,
    group = TheWarWithin.groups.FOR_THE_COLLECTIVE,
