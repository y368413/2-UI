...
L == "zhCN" and {
	...
	["Clear all tentative parties."] = "右键清除选择。",
	...
	["%d |4party:parties; remaining..."] = "%d 派遣",
	["%d active"] = "激活%d",
	["%d/%d active missions complete"] = "（%d/%d）任务完成。",
	...
	["Send Tentative Parties"] = "一键派遣",
	["Set tentative party"] = "右键选择",
	["+%s experience expected"] = "预计 +%s 经验",
	["%s is not required by any Missions of Interest."] = "%s没有任务所需要的。",
	["%s is required by the following Missions of Interest."] = "%s 是以下任务需要的随从",
	["%sk"] = "%sw",
	Skipped = "已忽略",
	["Start Missions"] = "开始任务",
	Statistics = "统计",
...
这可能会影响建议的队伍和任务排序顺序。]=],
	...
	["You have no followers with this trait."] = "还没有该专长的追随者！",
	["You have no free bag slots."] = "你没有多余的背包空间。",
	["You may replace these traits:"] = "以下专长应重新替换：",
