...
if I.MyClass ~= "ROGUE" then return end

local diceSpells = {
	[1] = {id = 193356, text = U["Combo"]},
	[2] = {id = 193357, text = U["Crit"]},
	[3] = {id = 193358, text = U["AttackSpeed"]},
	[4] = {id = 193359, text = U["CD"]},
	[5] = {id = 199603, text = U["Strike"]},
	[6] = {id = 199600, text = U["Power"]},
}
...
function A:PostCreateLumos(self)
	...
	local buttons = {}
	local parent = R.db["Nameplate"]["TargetPower"] and self.Health or self.ClassPowerBar
	for i = 1, 6 do
		...
		if i == 1 then
			bu:SetPoint("BOTTOMLEFT", parent, "TOPLEFT", 0, R.margin)
		else
