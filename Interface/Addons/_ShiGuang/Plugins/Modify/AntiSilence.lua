--## Author: 他们都叫我谷歌 ## Version: v1.0.7
local AntiSilence = CreateFrame("Frame")
local debug = false

-- 关键字列表
local keywordsType1 = {"公会YY", "工会YY", "局长", "微信", "gm",  "自杀",  "自焚", "8500", "89", "傻子", "GCD", "共CD", "BL", "狗贼", "憨批"}
local keywordsType2 = {"gay", "屌", "二奶", "脑残", "干死", "文革", "菜逼", "sb", "傻批", "叼毛", "傻逼", "傻B", "我日", "白痴", "蠢货", "废物", "狗东西", "你妈", "我草", "我操", "死妈", "艹你", "草的你", "你大爷", "操他" , "他妈", "妈的", "tmd", "jb", "j8", "寄吧", "几把", "鸡吧", "妈逼", "草拟吗","草泥马","国军"}
