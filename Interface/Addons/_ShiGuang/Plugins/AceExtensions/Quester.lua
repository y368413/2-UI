--## Author: Nevcairiel ## Version: 11.0.2.0
local Quester = LibStub("AceAddon-3.0"):NewAddon("Quester", "AceHook-3.0", "AceConsole-3.0", "LibSink-2.0")
--local QuesterL = LibStub("AceLocale-3.0"):GetLocale("Quester")
local QuesterL = {}

if GetLocale() == "zhCN" then
QuesterL["Allows easy identification of daily/weekly quests, as well as raid and dungeon quests."] = "可轻松识别每日/每周任务，以及突袭和地下城任务。"
QuesterL["Always show objective percentage values on progress bars"] = "始终在进度条上显示客观百分比值"
QuesterL["Behavior Configuration"] = "性能配置"
QuesterL["Configure the sounds you want to hear with the toggles below."] = "配置你想听到下面的切换的声音"
QuesterL["Difficulty Coloring"] = "难度着色"
QuesterL["Enable the coloring of quests according to their difficulty in NPC and Item tooltips."] = "允许在NPC及物品提示处对任务难度进行着色"
QuesterL["Enable the coloring of quests according to their difficulty in the quest tracker."] = "允许在任务追踪器中对任务难度进行着色"
QuesterL["Enable the coloring of quests according to their difficulty on NPC Gossip frames."] = "允许在NPC闲聊对话框中对任务难度进行着色"
QuesterL["Gossip frames"] = "闲聊框体"
QuesterL["Highlight most valuable reward"] = "高亮最有价值的奖励"
QuesterL["Highlight the reward with the highest vendor value when completing a quest."] = "当完成任务时，将卖店价最高的物品高亮显示。"
QuesterL["Instead of 2/8, show 6"] = "而不是2/8，显示6"
QuesterL["Job's Done!"] = "工作完成"
QuesterL["Lock the Objective Tracker in place"] = "将目标跟踪器锁定到位"
QuesterL["More Work?!"] = "更多工作？"
QuesterL["Note: Changing this option may require your UI to be reloaded to take full effect."] = "注意：更改此项设定可能需要重载用户界面才能生效"
QuesterL["Only show number of objective items remaining"] = "仅显示剩余的目标项数"
QuesterL["Peasant"] = "农夫"
QuesterL["Peon"] = "苦工"
QuesterL["Progress Output"] = "进程输出"
QuesterL["Quest Tracker"] = "任务追踪器"
QuesterL["Remove numbers from single task objectives"] = "从单个任务目标中删除数字"
QuesterL["Reset Position"] = "重置位置"
QuesterL["Reset the position of the Objective Tracker to the default."] = "将“目标跟踪器”的位置重置为默认值。"
QuesterL["Select the set of sounds to use."] = "选择使用的语音组"
QuesterL["Show Quest Level"] = "显示任务等级"
QuesterL["Show Quest Tag Icons in the Objective Tracker"] = "在目标跟踪器中显示任务标记图标"
QuesterL["Sound Configuration"] = "声音配置"
QuesterL["Sound Set"] = "语音组"
QuesterL["Toggle if completing a quest should automatically remove it from the tracker."] = "切换当完成某项任务时是否自动从跟踪列表中移除"
QuesterL["Toggle if quest levels are shown in various parts of the UI."] = "切换是否在多个界面位置显示任务等级"
QuesterL["Toggle playing the 'Job's Done!' sound after completing a quest."] = "切换当完成某项任务时是否播放“工作完成”语音"
QuesterL["Toggle playing the 'More Work?!' sound after completing an objective."] = "切换当完成某项任务目标时是否播放“更多工作”语音"
QuesterL["Toggling this option may require a UI reload to fully take effect."] = "切换此选项可能需要UI重新加载才能完全生效。"
QuesterL["Tooltips"] = "提示"
QuesterL["Unlock Quest Tracker position"] = "解锁Quest Tracker位置"
QuesterL["Unlock the position of the Objective Tracker, allowing it to be moved by clicking and dragging its header."] = "解锁目标跟踪器的位置，允许通过单击并拖动其标题来移动它。"
QuesterL["Un-track complete quests"] = "不追踪已完成任务"
QuesterL["You can select where you want progress messages displayed using the options below."] = "你可以在下面的列表中选择任务进程报告的输出位置。"
QuesterL["You can unlock it again in the options"] = "您可以在选项中再次解锁"
QuesterL["QuesterTitle"] = "|cffFF6A00[任务]|r功能增强";
elseif GetLocale() == "zhTW" then
QuesterL["Allows easy identification of daily/weekly quests, as well as raid and dungeon quests."] = "可以輕鬆識別每日/每週任務，以及團隊和地下城任務。"
QuesterL["Always show objective percentage values on progress bars"] = "始終顯示目標進度條的百分比"
QuesterL["Behavior Configuration"] = "行為設定"
QuesterL["Configure the sounds you want to hear with the toggles below."] = "在下面切換你想聽到的聲音。"
QuesterL["Difficulty Coloring"] = "難度著色"
QuesterL["Enable the coloring of quests according to their difficulty in NPC and Item tooltips."] = "根據任務難度對NPC與物品提示啟用著色。"
QuesterL["Enable the coloring of quests according to their difficulty in the quest tracker."] = "根據任務難度對任務追蹤器啟用著色。"
QuesterL["Enable the coloring of quests according to their difficulty on NPC Gossip frames."] = "根據任務難度對NPC對話框架啟用著色。"
QuesterL["Gossip frames"] = "對話框架"
QuesterL["Highlight most valuable reward"] = "高亮最有價值的獎賞"
QuesterL["Highlight the reward with the highest vendor value when completing a quest."] = "當完成一個任務時，高亮顯示販售價值最高的獎賞。"
QuesterL["Instead of 2/8, show 6"] = "顯示6來取代2/8"
QuesterL["Job's Done!"] = "工作完成！"
QuesterL["Lock the Objective Tracker in place"] = "鎖定任務追蹤器位置"
QuesterL["More Work?!"] = "更多工作？"
QuesterL["Note: Changing this option may require your UI to be reloaded to take full effect."] = "注意：更改此選項可能需要重新加載您的插件才能完全發揮效用。"
QuesterL["Only show number of objective items remaining"] = "僅顯示剩餘的目標物品數"
QuesterL["Peasant"] = "農夫"
QuesterL["Peon"] = "苦工"
QuesterL["Progress Output"] = "進度輸出"
QuesterL["Quest Tracker"] = "任務追蹤器"
QuesterL["Remove numbers from single task objectives"] = "從單個任務目標中刪除數字"
QuesterL["Reset Position"] = "重置位置"
QuesterL["Reset the position of the Objective Tracker to the default."] = "重置任務追蹤器為預設位置。"
QuesterL["Select the set of sounds to use."] = "選擇要使用的音效設置。"
QuesterL["Show Quest Level"] = "顯示任務等級"
QuesterL["Show Quest Tag Icons in the Objective Tracker"] = "在目標追蹤器中顯示任務標籤"
QuesterL["Sound Configuration"] = "聲音設定"
QuesterL["Sound Set"] = "音效設置"
QuesterL["Toggle if completing a quest should automatically remove it from the tracker."] = "切換是否在任務完成時自動自追蹤器移除。"
QuesterL["Toggle if quest levels are shown in various parts of the UI."] = "切換是否在用戶介面各處示任務等級。"
QuesterL["Toggle playing the 'Job's Done!' sound after completing a quest."] = "切換是否在完成任務後播放「工作完成！」音效。"
QuesterL["Toggle playing the 'More Work?!' sound after completing an objective."] = "切換是否在完成任務目標後播放「更多工作？」音效。"
QuesterL["Toggling this option may require a UI reload to fully take effect."] = "切換此選項可能需要重新載入UI方能完全生效。"
QuesterL["Tooltips"] = "工具提示"
QuesterL["Unlock Quest Tracker position"] = "解鎖任務追蹤器位置"
QuesterL["Unlock the position of the Objective Tracker, allowing it to be moved by clicking and dragging its header."] = "解鎖任務追蹤器的位置，使其能夠透過拖曳標題而被移動。"
QuesterL["Un-track complete quests"] = "不追蹤已完成任務"
QuesterL["You can select where you want progress messages displayed using the options below."] = "您可以使用以下的選項選擇您要顯示進度訊息的地方。"
QuesterL["You can unlock it again in the options"] = "您可以在選項內再次解鎖"
QuesterL["QuesterTitle"] = "|cffFF6A00[任务]|r功能增强";
else
QuesterL["Allows easy identification of daily/weekly quests, as well as raid and dungeon quests."] = true
QuesterL["Always show objective percentage values on progress bars"] = true
QuesterL["Behavior Configuration"] = true
QuesterL["Configure the sounds you want to hear with the toggles below."] = true
QuesterL["Difficulty Coloring"] = true
QuesterL["Enable the coloring of quests according to their difficulty in NPC and Item tooltips."] = true
QuesterL["Enable the coloring of quests according to their difficulty in the quest tracker."] = true
QuesterL["Enable the coloring of quests according to their difficulty on NPC Gossip frames."] = true
QuesterL["Gossip frames"] = true
QuesterL["Highlight most valuable reward"] = true
QuesterL["Highlight the reward with the highest vendor value when completing a quest."] = true
QuesterL["Instead of 2/8, show 6"] = true
QuesterL["Job's Done!"] = true
QuesterL["Lock the Objective Tracker in place"] = true
QuesterL["More Work?!"] = true
QuesterL["Note: Changing this option may require your UI to be reloaded to take full effect."] = true
QuesterL["Only show number of objective items remaining"] = true
QuesterL["Peasant"] = true
QuesterL["Peon"] = true
QuesterL["Progress Output"] = true
QuesterL["Quest Tracker"] = true
QuesterL["Remove numbers from single task objectives"] = true
QuesterL["Reset Position"] = true
QuesterL["Reset the position of the Objective Tracker to the default."] = true
QuesterL["Select the set of sounds to use."] = true
QuesterL["Show Quest Level"] = true
QuesterL["Show Quest Tag Icons in the Objective Tracker"] = true
QuesterL["Sound Configuration"] = true
QuesterL["Sound Set"] = true
QuesterL["Toggle if completing a quest should automatically remove it from the tracker."] = true
QuesterL["Toggle if quest levels are shown in various parts of the UI."] = true
QuesterL["Toggle playing the 'Job's Done!' sound after completing a quest."] = true
QuesterL["Toggle playing the 'More Work?!' sound after completing an objective."] = true
QuesterL["Toggling this option may require a UI reload to fully take effect."] = true
QuesterL["Tooltips"] = true
QuesterL["Unlock Quest Tracker position"] = true
QuesterL["Unlock the position of the Objective Tracker, allowing it to be moved by clicking and dragging its header."] = true
QuesterL["Un-track complete quests"] = true
QuesterL["You can select where you want progress messages displayed using the options below."] = true
QuesterL["You can unlock it again in the options"] = true
QuesterL["QuesterTitle"] = "|cffFF6A00[Quest]|rQuester";
end
...
local function getOptionsTable()
	local options = {
		type = "group",
		name = QuesterL["QuesterTitle"],
		get = function(k) return db[k.arg] end,
		set = function(k, v) db[k.arg] = v end,
		args = {
			behaviorheader = {
				type = "header",
				name = QuesterL["Behavior Configuration"],
				order = 1,
			},
			questLevel = {
				name = QuesterL["Show Quest Level"],
				desc = QuesterL["Toggle if quest levels are shown in various parts of the UI."] .. "\n" .. QuesterL["Note: Changing this option may require your UI to be reloaded to take full effect."],
				type = "toggle",
				arg = "questLevels",
				order = 2,
				width = "full",
			...
			removeComplete = {
				name = QuesterL["Un-track complete quests"],
				desc = QuesterL["Toggle if completing a quest should automatically remove it from the tracker."],
				type = "toggle",
				arg = "removeComplete",
				order = 3,
				width = "full",
			...
			highlightReward = {
				name = QuesterL["Highlight most valuable reward"],
				desc = QuesterL["Highlight the reward with the highest vendor value when completing a quest."],
				type = "toggle",
				arg = "highlightReward",
				order = 4,
				width = "full",
			...
			showObjectivePercentages = {
				name = QuesterL["Always show objective percentage values on progress bars"],
				desc = QuesterL["Toggling this option may require a UI reload to fully take effect."],
				type = "toggle",
			...
			hide01 = {
				name = QuesterL["Remove numbers from single task objectives"],
				type = "toggle",
				arg = "hide01",
				order = 4.6,
				width = "full",
			...
			shortenNumbers = {
				name = QuesterL["Only show number of objective items remaining"],
				desc = QuesterL["Instead of 2/8, show 6"],
				type = "toggle",
				arg = "shortenNumbers",
				order = 4.6,
				width = "full",
			...
			showTagIcons = {
				name = QuesterL["Show Quest Tag Icons in the Objective Tracker"],
				desc = QuesterL["Allows easy identification of daily/weekly quests, as well as raid and dungeon quests."],
				type = "toggle",
				arg = "showTagIcons",
				order = 4.7,
				width = "full",
			...
			colorheader = {
				type = "header",
				name = QuesterL["Difficulty Coloring"],
				order = 5,
			},
			gossipColor = {
				name = QuesterL["Gossip frames"],
				desc = QuesterL["Enable the coloring of quests according to their difficulty on NPC Gossip frames."],
				type = "toggle",
				arg = "gossipColor",
				order = 6,
				width = "double",
			...
			questTrackerColor = {
				name = QuesterL["Quest Tracker"],
				desc = QuesterL["Enable the coloring of quests according to their difficulty in the quest tracker."],
				type = "toggle",
			...
			tooltipColor = {
				name = QuesterL["Tooltips"],
				desc = QuesterL["Enable the coloring of quests according to their difficulty in NPC and Item tooltips."],
				type = "toggle",
				arg = "tooltipColor",
				order = 8,
				width = "double",
			...
			soundheader = {
				type = "header",
				name = QuesterL["Sound Configuration"],
				order = 10,
			},
			sounddesc = {
				type = "description",
				name = QuesterL["Configure the sounds you want to hear with the toggles below."],
				order = 11,
			},
			soundSet = {
				type = "select",
				name = QuesterL["Sound Set"],
				desc = QuesterL["Select the set of sounds to use."],
				arg = "soundSet",
				values = { QuesterL["Peasant"], QuesterL["Peon"] },
				order = 12,
			},
			sound_nl = {
				type = "description",
			...
			morework = {
				name = QuesterL["More Work?!"],
				desc = QuesterL["Toggle playing the 'More Work?!' sound after completing an objective."],
				type = "toggle",
				arg = "morework",
				order = 15,
			},
			jobsdone = {
				name = QuesterL["Job's Done!"],
				desc = QuesterL["Toggle playing the 'Job's Done!' sound after completing a quest."],
				type = "toggle",
				arg = "jobsdone",
				order = 16,
			},
			header = {
				type = "header",
				name = QuesterL["Progress Output"],
				order = 20,
			},
			desc = {
				type = "description",
				name = QuesterL["You can select where you want progress messages displayed using the options below."],
				order = 21,
			},
...
local sounds = {
	[1] = {
		...
		"Interface\\AddOns\\_ShiGuang\\Media\\Sounds\\jobsdone.ogg"
	},
	[2] = {
...
function Quester:OnInitialize()
	...
	LibStub("AceConfigRegistry-3.0"):RegisterOptionsTable(QuesterL["QuesterTitle"], getOptionsTable)
	local _, optionsCategory = LibStub("AceConfigDialog-3.0"):AddToBlizOptions(QuesterL["QuesterTitle"], QuesterL["QuesterTitle"])
...
function Quester:ObjectiveTracker_AddObjective(block, objectiveKey, text, template, useFullHeight, dashStyle, colorStyle, adjustForNoText, overrideHeight)
	...
	if colorStyle == OBJECTIVE_TRACKER_COLOR["Header"] then
		...
		if progress[text] then
			...
			line.Text:SetText(format("|cff%s%s|r", rgb2hex(ColorGradient(progress[text].perc, 0.8,0.8,0.8, 1,1,0, 0,1,0)), newText or text))
		end
	end
end
...
function Quester:SetRewardHighlight(reward)
	if not self.rewardHighlightFrame then
		self.rewardHighlightFrame = CreateFrame("Frame", "QuesterRewardHighlight", QuestInfoRewardsFrame, "AutoCastOverlayTemplate")
		self.rewardHighlightFrame:SetScript("OnHide", function(frame) frame:ShowAutoCastEnabled(false) end)
	end
	self.rewardHighlightFrame:SetSize(42, 42)
	self.rewardHighlightFrame:ClearAllPoints()
	self.rewardHighlightFrame:SetPoint("CENTER", reward, "CENTER")
	self.rewardHighlightFrame:Show()
	self.rewardHighlightFrame:ShowAutoCastEnabled(true)
end
