...
R.DeprecatedAuras = {
	...
	-- 暗夜要塞
		...
		{AuraID = 206617, UnitID = "player", Text = U["Get Out"]},	-- 时间炸弹
	...
	-- 萨格拉斯之墓
		...
		{AuraID = 235213, UnitID = "player", Text = U["AW Light"]},	-- 光明灌注
		{AuraID = 235240, UnitID = "player", Text = U["AW Fel"]},	-- 邪能灌注
		-- 堕落的化身
	...
	-- 燃烧王座
		...
		{AuraID = 244055, UnitID = "player", Text = U["Shadow Side"]},	-- 暗影触痕
		{AuraID = 244054, UnitID = "player", Text = U["Fire Side"]},	-- 烈焰触痕
		-- 安托兰统帅议会
		...
		{AuraID = 255029, UnitID = "player", Text = U["Get Out"]},	-- 催眠气罐
		-- 金加洛斯
		...
		{AuraID = 244094, UnitID = "player", Text = U["Get Out"]},	-- 冥魂之拥
		-- 破坏魔女巫会
		...
		{AuraID = 248396, UnitID = "player", Text = U["Get Out"]},	-- 灵魂凋零
		{AuraID = 250669, UnitID = "player", Text = U["Get Out"]},	-- 灵魂爆发
	},
	["Warning"] = {			-- 目标重要光环组
	-- 7.0副本
