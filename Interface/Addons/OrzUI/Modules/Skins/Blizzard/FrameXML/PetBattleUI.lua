...
tinsert(R.defaultThemes, function()
	...
	-- Reskin Petbar
	local bar = CreateFrame("Frame", "OrzUIPetBattleBar", UIParent, "SecureHandlerStateTemplate")
	...
	hooksecurefunc("PetBattleFrame_UpdateActionBarLayout", function(self)
		...
		for i = 1, 6 do
			...
			bu:GetPushedTexture():SetTexture(I.pushedTex)
	...
	skipButton:SetPushedTexture(I.pushedTex)
