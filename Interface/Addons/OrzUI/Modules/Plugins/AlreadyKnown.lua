...
-- merchant frame  --Not cool work for pet and toys
	...
	for i = 1, MERCHANT_ITEMS_PER_PAGE do
		...
		if button and button:IsShown() then
			...
			if isUsable and IsAlreadyKnown(GetMerchantItemLink(index)) then
				...
				_G["MerchantItem"..i.."ItemButtonIconTexture"]:SetDesaturated(IsAlreadyKnown(GetMerchantItemLink(index)))
				--_G["MerchantItem" .. i]:SetAlpha(0.25)
				--if _G["MerchantItem" .. i].icon then _G["MerchantItem" .. i].icon:SetDesaturated(IsAlreadyKnown(GetMerchantItemLink(index))) end
			else 
			    --_G["MerchantItem" .. i]:SetAlpha(1.0) 
