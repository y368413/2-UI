...
function info:FriendsPanel_Init()
	...
	infoFrame = CreateFrame("Frame", "OrzUIFriendsFrame", info)
	...
	local scrollFrame = CreateFrame("ScrollFrame", "OrzUIFriendsInfobarScrollFrame", infoFrame, "HybridScrollFrameTemplate")
...
function info:FriendsPanel_Update()
	local scrollFrame = OrzUIFriendsInfobarScrollFrame
	local usedHeight = 0
...
info.onEnter = function(self)
	...
	if OrzUIGuildInfobar and OrzUIGuildInfobar:IsShown() then
		OrzUIGuildInfobar:Hide()
	end
