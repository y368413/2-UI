...
function Bar:MicroMenu_Setup()
	...
	local maxButtons = 11 -- total buttons 13
...
function Bar:MicroMenu()
	...
	-- Generate Buttons
	local buttonInfo = {
			{"UI-CheckBox-Up", "CharacterMicroButton"},  --UI-MicroButton-Raid-Up UI-SquareButton-Up
			...
			{"UI-CheckBox-Up", "HousingMicroButton"},  --UI-MicroButton-BStore-Up
			...
			--{"Button-Backpack-Up", function() ToggleAllBags() end, MicroButtonTooltipText(BAGSLOT, "OPENALLBAGS")},  --UI-MicroButton-Abilities-Up
	}
