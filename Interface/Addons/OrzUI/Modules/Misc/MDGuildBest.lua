...
function MISC:KeystoneInfo_Create()
	...
	button:SetScript("OnEnter", function(self)
		...
		for fullName, info in pairs(OrzUISetDB["KeystoneInfo"]) do
...
function MISC:KeystoneInfo_Update()
	...
	if mapID then
		OrzUISetDB["KeystoneInfo"][I.MyFullName] = mapID..":"..keystoneLevel..":"..I.MyClass..":"..I.MyFaction
	else
		OrzUISetDB["KeystoneInfo"][I.MyFullName] = nil
	end
end
