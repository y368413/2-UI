...
function MISC:Expbar()
	...
	local bar = CreateFrame("StatusBar", "OrzUIExpRepBar", MinimapCluster)
    ...
    bar.ArtifactText:SetFont("Interface\\AddOns\\OrzUI\\Media\\Fonts\\Infinity.ttf", 11, "OUTLINE")  --STANDARD_TEXT_FONT
