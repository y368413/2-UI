...
,{"分解","163145",[[#showtooltip
/cast 分解
/actfunctions 分解
/use]]
,[[2UI专属快速分解，无脑一直点，慎用!!!!!
选矿、研磨、开锁同理，替换宏名称、技能名称即可]]}
,{"追踪","163245",[[/actfunctions 追踪]]
,[[2UI专属LR快速对应种族追踪，对着动物使用，追踪该种族生物，再点取消。]]}
,{"坐骑","163455",[[/actfunctions 坐骑
/use]]
...
function CreateMrMacroFrame()
	...
	f.HorizontalBarLeft:SetPoint("TOPLEFT",f,"TOPLEFT",2,-420)
	...
	f.HorizontalBarLeft2:SetPoint("TOPLEFT",f,"TOPLEFT",2,-505)
...
function createText()
	...
	f.textframe:SetPoint("TOPLEFT",f.scroll,"BOTTOMLEFT",0,-88)
...
function createNote()
	...
	f.noteframe:SetPoint("TOPLEFT",f.scroll,"BOTTOMLEFT",45,-3)
