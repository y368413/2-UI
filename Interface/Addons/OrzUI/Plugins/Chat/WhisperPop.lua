...
function WhisperSoundTip:CHAT_MSG_WHISPER() PlaySoundFile("Interface\\AddOns\\OrzUI\\Media\\Sounds\\Whisper.ogg", "Master") end
...
function WhisperPop:OnNewMessage(name, text, inform, guid)
	if not inform and self.db.sound then
		PlaySoundFile("Interface\\AddOns\\OrzUI\\Media\\Sounds\\Whisper.ogg", "Master") -- Got new message!
	end
end
...
frame:SetPoint("BOTTOMLEFT", UIParent,"BOTTOMLEFT",10, 210)   --210，0
