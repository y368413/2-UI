--- @class DialogKeyNS ## Version: v1.2.41 ## Author: Numy (previous verions by: Foxthorn, N01ch, FuriousProgrammer)
local DialogKeyNS = {}
...
function DialogKeyNS:OpenConfig()
