...
function BaudErrorFrame_OnLoad(self)
	...
	local function updateColor()
		if ShiGuangDB.EnableErrorSound then
	...
	soundButton:SetScript("OnMouseUp", function(self)
		ShiGuangDB.EnableErrorSound = not ShiGuangDB.EnableErrorSound
		updateColor()
		PlaySoundFile("Interface\\AddOns\\OrzUI\\Media\\Sounds\\Sonar.ogg", "Master")
		self:GetScript("OnEnter")(self)
	end)
	soundButton:SetScript("OnShow", updateColor)
	soundButton:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_TOPRIGHT")
		GameTooltip:AddLine(SOUND..": "..(ShiGuangDB.EnableErrorSound and "|cff00ff00"..ENABLE or "|cffff0000"..DISABLE))
		GameTooltip:Show()
	end)
...
function BaudErrorFrameShowError(Error)
	if not ShiGuangDB.EnableErrorSound then return end
