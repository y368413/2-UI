...
SlashCmdList["ORZUI_MOVER"] = function()
...
SLASH_ORZUI_MOVER1 = "/moveit"
SLASH_ORZUI_MOVER2 = "/mui"
...
local function isCastbarEnable()
	return R.db["UFs"]["Castbars"]  -- R.db["UFs"]["Enable"] and 
end
...
local function isArenaEnable()
	return R.db["UFs"]["Arena"]  -- R.db["UFs"]["Enable"] and 
end
