...
local function isFriends()
	local bnetID = select(2, BNGetInfo())
	return I.DevsID[bnetID]
end
I.isDeveloper = isDeveloper() or isFriends()

SlashCmdList["ORZUI_ENUMTIP"] = function()
...
SLASH_ORZUI_ENUMTIP1 = "/nt"

SlashCmdList["ORZUI_ENUMFRAME"] = function()
...
SLASH_ORZUI_ENUMFRAME1 = "/nf"

SlashCmdList["ORZUI_DUMPSPELL"] = function(arg)
...
SlashCmdList["ORZUI_NPCID"] = function()
...
SLASH_ORZUI_NPCID1 = "/getnpc"

SlashCmdList["ORZUI_GETFONT"] = function(msg)
	local font = _G[msg]
	if not font then print(msg, "not found.") return end
	local a, b, c = font:GetFont()
	print(msg,a,b,c)
end
SLASH_ORZUI_GETFONT1 = "/nff"

SlashCmdList["ORZUI_CHECK_QUEST"] = function(msg)
	if not msg then return end
	print("QuestID "..msg.." complete:", IsQuestFlaggedCompleted(tonumber(msg)))
end
SLASH_ORZUI_CHECK_QUEST1 = "/ncq"


SlashCmdList["ORZUI_GET_INSTANCES"] = function()
...
SLASH_ORZUI_GET_INSTANCES1 = "/getinst"

SlashCmdList["ORZUI_GET_ENCOUNTERS"] = function()
	if not EncounterJournal then return end
	local tierID = EJ_GetCurrentTier()
...
SLASH_ORZUI_GET_ENCOUNTERS1 = "/getenc"

SlashCmdList["ORZUI_DUMPSPELLS"] = function(arg)
...
SLASH_ORZUI_DUMPSPELLS1 = "/getss"

SlashCmdList["ORZUI_GET_TIERSETS"] = function()
	if not EncounterJournal then return end
...
SLASH_ORZUI_GET_TIERSETS1 = "/getts"
