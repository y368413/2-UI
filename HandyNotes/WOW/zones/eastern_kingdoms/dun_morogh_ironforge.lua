...
local map = WorldOfWarcraft.Map({id = 27, settings = true})
local ironforge = WorldOfWarcraft.Map({id = 87, settings = true})
local new_tinkertown = WorldOfWarcraft.Map({id = 469, settings = true})
local coldridge_valley = WorldOfWarcraft.Map({id = 427, settings = true})
...
new_tinkertown.nodes[45605280] = WorldOfWarcraft.node.CrazyForCats({
    parent = map.id,
    id = 68838,
    rewards = {
        WorldOfWarcraft.reward.Achievement({id = 8397, criteria = 23585, oneline = true}),
        WorldOfWarcraft.reward.Pet({id = 1162})
    },
    pois = {
        POI({
