...
local map = WorldOfWarcraft.Map({id = 94, settings = true})
local sunstrider_isle = WorldOfWarcraft.Map({id = 467, settings = true})
local silvermoon = WorldOfWarcraft.Map({id = 110, settings = true})
